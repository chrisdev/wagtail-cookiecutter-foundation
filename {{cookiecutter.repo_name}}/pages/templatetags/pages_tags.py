...
@register.inclusion_tag('pages/tags/site_menu.html', takes_context=True)
...
@register.inclusion_tag('pages/tags/site_menu_children.html', takes_context=True)
...
@register.inclusion_tag('pages/tags/secondary_menu.html', takes_context=True)
...
@register.inclusion_tag('pages/tags/breadcrumbs.html', takes_context=True)
