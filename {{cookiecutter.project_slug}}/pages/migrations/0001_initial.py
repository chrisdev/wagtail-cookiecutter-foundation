    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('link_document', models.ForeignKey(related_name='+', blank=True, to='wagtaildocs.Document', null=True, on_delete=models.SET_NULL,)),
                ('link_page', models.ForeignKey(related_name='+', blank=True, to='wagtailcore.Page', null=True, on_delete=models.SET_NULL,)),
                ('page', models.ForeignKey(related_name='testimonials', blank=True, to='wagtailcore.Page', null=True, on_delete=models.SET_NULL,)),
        ...
        migrations.AddField(
            model_name='contentblock',
            name='page',
            field=models.ForeignKey(related_name='contentblocks', blank=True, to='wagtailcore.Page', null=True, on_delete=models.SET_NULL,),
        ),
    ]
